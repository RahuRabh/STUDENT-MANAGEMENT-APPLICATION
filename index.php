          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-12">
                ...
                <h5 align="center">STUDENT MANAGEMENT APPLICATION</h5>
  ...
  if(isset($_POST['login'])){
    ...
    if($userType == "Administrator"){
      ...
      if($num > 0){
        ...
        echo "<div class='alert alert-danger' role='alert'>
        Invalid  Teacher Username/Password!
        </div>";
      ...
      $query = "SELECT * FROM tblstudents WHERE admissionNumber = '$username' AND password = '12345' ";
      $rs = $conn->query($query);
      echo $rs->num_rows;
      $num = $rs->num_rows;
      $rows = $rs->fetch_assoc();
      ...
      if($num > 0){
        ...
        echo $_SESSION['userId'], $_SESSION['firstName'], $_SESSION['emailAddress'];
      ...
      echo "<div class='alert alert-danger' role='alert'>
      Invalid Universal Username/Password!
      </div>";
